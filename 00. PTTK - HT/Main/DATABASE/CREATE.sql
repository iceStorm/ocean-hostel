...
(
	...
	CONSTRAINT		PK__NOIQUY							PRIMARY KEY(MANOIQUY)
);
...
(
	...
	CONSTRAINT		PK__KHACH_VIPHAM					PRIMARY KEY(MAKHACH, MANOIQUY, THOIGIANVIPHAM),
	CONSTRAINT		FK__KHACH_VIPHAM__MAKHACH			FOREIGN KEY(MAKHACH)	REFERENCES KHACH(MAKHACH),
	CONSTRAINT		FK__KHACH_VIPHAM__MANOIQUY			FOREIGN	KEY(MANOIQUY)	REFERENCES NOIQUY(MANOIQUY)
);
